...
<thead>
    <tr>
<!--        <td>Server Name</td><td> IP server</td> <td> Ping </td> <td>  Player Info</td> <td>  Joueurs</td><td>  Version</td> <td> Battleye</td> -->
  <td>Server Name</td><td> IP server</td> <td> Ping </td> <td>  Player Info</td> <td>  Joueurs</td><td>  Version</td>
        ...
        <td><?php print_r($connect); ?></td>
        <td><?php print_r($ping); ?></td>
...
<thead>
    <tr>
       <td_>Player:   <?php    if(count($players) == 0)   {   echo " (0 joueurs) ";   }  else  {   echo " ☠  ONLINE ☠ " ;   }  ?>
      </td_> 
<!--td style="text-align: center;">Debug</td-->
 ...
 echo " " .  $numplayers  . "  Joueur(s) sur le server!" ; 
// echo " Player " . $numplayers;
//echo "";
  }
