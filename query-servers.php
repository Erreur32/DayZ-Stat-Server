...
echo "<div class='players' title='Show Player Listing'><div class='like-link'><font size=4'><span class='label label-primary'>Players sur le serveur ToX  (  <span style='color:red;'><b> " . $server
['gq_numplayers'] . "</b></span> ) </span></font></div></div><br>\n";
       ...
       echo "<center><h1><span class='label label-danger'> <!--<p class='error1'>-->SERVER " . $key . " is down.</span></h1></center>";
       echo "</div>";
      exit();
       }
      }
